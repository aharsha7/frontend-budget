...
function TransactionTable({ transactions, setTransactions, onUpdateClick, refreshTransactions }) {
  ...
  const handleDelete = async () => {
    try {
      ...
      const updated = transactions.filter((txn) => txn.id !== transactionToDelete);
